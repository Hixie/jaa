...
TextStyle small(BuildContext context) => DefaultTextStyle.of(context).style.apply(fontSizeFactor: 0.75);
TextStyle tiny(BuildContext context) => DefaultTextStyle.of(context).style.apply(fontSizeFactor: 0.66);
